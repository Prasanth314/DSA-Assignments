...
class AVL
{
    ...
    Node<V>* insert_node(V val,Node<V> *n)
    {
        if(!n)
        {
        ...
        if(val<n->value)
        n->left=insert_node(val,n->left);
        else if(val>n->value)
        n->right=insert_node(val,n->right);
        else
        {
        ...
        {
            if(val<((n->left)->value)) // Left-Left insertion
                return rightrotate(n);
            else if(val>((n->left)->value))  // Left-Right insertion
            {
                n->left=leftrotate(n->left);
                return rightrotate(n);
            }
        ...
        {
            if(val>(n->right)->value)   //  Right-Right insertion
                return leftrotate(n);
            else if(val<(n->right)->value)  //  Right-Left insertion
            {
                n->right=rightrotate(n->right);
                return leftrotate(n);
            }
...
int main()
{
    ...
    // cout<<tree.search("11.3")<<endl;
    // cout<<tree.search(88)<<endl;
    // cout<<tree.search(10)<<endl;
    // cout<<tree.countelem("11.3")<<endl;
    // cout<<tree.findklargest(10)<<endl;
    // cout<<tree.lower_bound("9.2")<<endl;
